...
--
-- Switch to the "Data" tab in the TigerData Console
-- Creat e new "Query Tab" (+) sign at the top right
-- Copy and paste the code below into the query editor
-- 
-- ### Load data from S3
--
-- In TigerData Console: Actions->S3 Import
-- As path enter:
-- s3://timescale-demo-data/crypto_assets.csv
-- Select "Public" as access method
-- Click "Import CSV"
--
-- Repeat the steps above for the second file:
-- s3://timescale-demo-data/crypto_ticks.csv
-- Make sure to turn on "Hypertable partition" for the 'time' column
--
...
-- ## Preview data (highlight the SQL and click Run)
